  ...
  return (
    <Card className="text-center" style={{ width: '20rem' }}>
      ...
      <Card.Body>
        ...
        <Button variant="outline-dark" onClick={() => incrementFire({ id: post.id })}>🔥 {fireCount}</Button>
        <Button variant="outline-dark" onClick={() => incrementTrash({ id: post.id })}>🗑️ {trashCount}</Button>
      </Card.Body>
